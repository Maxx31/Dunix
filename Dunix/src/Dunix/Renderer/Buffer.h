...
namespace Dunix
{
	...
	//BufferElement is one Vertex attribute, like position, color, UV etc.
	struct BufferElement
	{
		...
		BufferElement() {}
		BufferElement(ShaderDataType InType, const std::string& InBufferName, bool InIsNormalized = false)
			: BufferName(InBufferName), Type(InType), Size(ShaderDataTypeSize(InType)), Offset(0), IsNormalized(InIsNormalized)
		{
		}
